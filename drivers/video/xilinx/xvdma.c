...
/*static const struct of_device_id __devinitconst xvmdae_of_match[] = {
	{ .compatible = "xlnx,axi-xvmdae-1.00.a", },
	{},
};
MODULE_DEVICE_TABLE(of, xvmdae_of_match);*/

static struct platform_driver xvdma_driver = {
	.driver = {
		   .name = DRIVER_NAME,
		   .owner = THIS_MODULE,
		   //.of_match_table = xvmdae_of_match,
		   },
	.probe = xvdma_probe,
